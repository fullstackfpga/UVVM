...
echo "\nCompiling TB\n"
echo "eval vcom  $compdirectives  ../tb/axi_slave_model_pkg.vhd"
eval vcom  $compdirectives  ../tb/axi_slave_model_pkg.vhd
echo "eval vcom  $compdirectives  ../tb/axi_slave_model.vhd"
eval vcom  $compdirectives  ../tb/axi_slave_model.vhd
echo "eval vcom  $compdirectives  ../tb/axi_vvc_th.vhd"
eval vcom  $compdirectives  ../tb/axi_th.vhd
echo "eval vcom  $compdirectives  ../tb/axi_simple_tb.vhd"
eval vcom  $compdirectives  ../tb/axi_simple_tb.vhd
echo "eval vcom  $compdirectives  ../tb/axi_vvc_tb.vhd"
eval vcom  $compdirectives  ../tb/axi_vvc_tb.vhd
