...
echo "\nCompiling TB\n"
echo "eval vcom  $compdirectives  ../tb/axilite_slave_model_pkg.vhd"
eval vcom  $compdirectives  ../tb/axilite_slave_model_pkg.vhd
echo "eval vcom  $compdirectives  ../tb/axilite_slave_model.vhd"
eval vcom  $compdirectives  ../tb/axilite_slave_model.vhd
echo "eval vcom  $compdirectives  ../tb/axilite_slave.vhd"
eval vcom  $compdirectives  ../tb/axilite_slave.vhd
echo "eval vcom  $compdirectives  ../tb/axilite_th.vhd"
eval vcom  $compdirectives  ../tb/axilite_th.vhd
echo "eval vcom  $compdirectives  ../tb/axilite_simple_tb.vhd"
eval vcom  $compdirectives  ../tb/axilite_simple_tb.vhd
echo "eval vcom  $compdirectives  ../tb/axilite_vvc_simple_tb.vhd"
eval vcom  $compdirectives  ../tb/axilite_vvc_simple_tb.vhd
